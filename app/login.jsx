        ...
        <View style={[tw.flex1, tw.justifyCenter, tw.p6]}>
          ...
          <View style={[tw.itemsCenter, tw.mB8]}>
            <View style={[
              ...
              <Text style={[tw.text5xl]}></Text>
            </View>
            <Text style={[tw.text3xl, tw.fontBold, tw.textWhite, tw.mT2, { fontFamily: 'SpaceMono' }]}>
              TrackEd
            </Text>
            <Text style={[tw.textBase, tw.textWhite, tw.textCenter, tw.mT1, { opacity: 0.8 }]}>
          ...
          <View style={[
            ...
            <View style={[tw.spaceY4]}>
              <View>
                <Text style={[tw.textSm, tw.fontMedium, tw.textGray700, tw.mB2]}>
                  Student Email
                </Text>
                <TextInput
                  style={[
